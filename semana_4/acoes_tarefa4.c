...
#define GERDAU_DISPONIVEL 10000
#define GERDAU_VALOR 14.00

#define PETROBRAS_DISPONIVEL 2000
#define PETROBRAS_VALOR 2.50

#define RENNER_DISPONIVEL 5000
#define RENNER_VALOR 1.20

#define VIVO_DISPONIVEL 500
#define VIVO_VALOR 2.2
...
int main(void)
{
    ...
    do {
        ...
        { // III ERRO - quantidade de acoes nao disponivel
            clear_screen();
            printf("0 acoes compradas! %s possui apenas %d acoes.\
                \nPressione enter para continuar.\n",
        ...
        if (acoes_compradas != 0) {
            ...
            opcao_selecionada,
            acoes_compradas,
            acoes_compradas * valor_arr[opcao_selecionada - 1]);
        }
        printf("Sucesso!\nPressione enter para continuar.");
        acoes_compradas = 0;
        compras++;
        ...
        getchar();
        clear_screen();
    } while(opcao_selecionada >= 1 && opcao_selecionada <= 4);
